            ...
            >
              <div className="carousel-inner">
                <div className="carousel-item active">
                  ...
                  >
                    <h4 style={{ color: 'rgb(68, 67, 67)' }}>Variable Orifice Valve</h4>
                  </div>
                </div>
              </div>
              <button
...
increased unburnt carbon in flash that leads to
...
valves is coal quality (coal hardness, coal
particle size and coal moisture).
